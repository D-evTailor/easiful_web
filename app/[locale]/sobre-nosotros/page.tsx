    ...
    <div className="min-h-screen py-8 md:py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-4xl relative">
        <div className="text-center mb-8 md:mb-16 animate-fade-in">
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold text-stone-800 mb-4 md:mb-6 leading-tight">{t("about.title")}</h1>
          <p className="text-base md:text-xl lg:text-2xl text-stone-600 leading-relaxed max-w-3xl mx-auto">{t("about.subtitle")}</p>
        </div>

        <div className="space-y-8 md:space-y-16 animate-slide-up">
          {/* Main Content */}
          <div className="bg-white/70 backdrop-blur-sm rounded-[2rem] p-6 md:p-8 lg:p-12 border border-stone-200/50 shadow-xl">
            <div className="space-y-4 md:space-y-8 text-sm md:text-lg text-stone-700 leading-relaxed">
              <p className="text-base md:text-xl font-medium text-stone-800 mb-4 md:mb-6">{t("about.content1")}</p>
